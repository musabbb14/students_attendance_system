...
if (isset($_GET['delete_id'])) {
    ...
    header("Location: manage_students.php?msg=removed&lvl=$saved_level&crs=$saved_course");
    exit();
}
...
<div class="table-container">
    ...
    <p>Logged in as: <strong><?php echo $teacher_name; ?></strong></p>
    ...
    <form method="POST" class="admin-filter-form">
        ...
        <button type="submit" name="show_list">View/Edit Students</button>
    </form>
        ...
        <table class="attendance-table">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="manage_students.php?delete_id=<?php echo $row['id']; ?>&lvl=<?php echo $saved_level; ?>&crs=<?php echo $saved_course; ?>" 
                           onclick="return confirm('Remove this student from the list?')" 
    ...
    <?php elseif(isset($_POST['show_list']) || isset($_GET['lvl'])): ?>
        <p class="error-msg">No records found for your name in this course/level.</p>
    <?php endif; ?>
